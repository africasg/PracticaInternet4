...
export const typeDefs = gql`
    ...
    type Mutation { register(email: String!, password: String!,username:String!): AuthPayload! 
    ...
    addMember(projectId:ID!, userID:ID!): Projects createTask(projectId:ID!,title:String!,status:String, priority:String!, dueDate: String!): Tasks! 
